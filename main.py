...
from src.stock_predictor.pipeline import stage_01_data_ingestion
from src.stock_predictor.pipeline.stage_01_data_ingestion import DataIngestionTrainingPipeline
